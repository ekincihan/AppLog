...
{
    public class GrayLogLogger : Core.Abstract.ILogger
    {
        #region Fields
        ...
        {
            Configure();
            Namespace = ReflectionHelper.WhoseThere();
        }
        ...
        public Core.Abstract.ILogger Current([CallerMemberName]string name = "")
        {
        ...
        {
            if (IsLevelLoggingEnabled(logLevel) == false)
            {
                return;
            }
